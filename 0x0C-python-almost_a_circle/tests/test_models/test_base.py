...
class TestBaseClass(unittest.TestCase):
    ...
    def test_with_non_integer_id(self):
        with self.assertRaises(ValueError):
            Base(id="not_an_integer")
    ...
    def test_constructor_with_large_id(self):
        obj = Base(id=10**10)
        self.assertEqual(obj.id, 10**10)

    def test_constructor_with_max_int_id(self):
        obj = Base(id=2**63 - 1)
        self.assertEqual(obj.id, 2**63 - 1)
